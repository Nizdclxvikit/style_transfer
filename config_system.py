...
def parse_args(state_obj=None):
    ...
    add_args(parser, [
        ...
        arg('--p-power', '-pp', metavar='P', type=ffloat, default=6, help='the p-norm eARGS.modelxponent'),
        ...
        arg('--model', default='/home/user/Documents/Dream/models/caffe/vgg19/VGG_ILSVRC_19_layers_deploy.prototxt',
            help='the Caffe deploy.prototxt for the model to use'),
        arg('--weights', default='/home/user/Documents/Dream/models/caffe/vgg19/VGG_ILSVRC_19_layers.caffemodel',
